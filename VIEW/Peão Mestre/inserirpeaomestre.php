...
<head>
    ...
    <title>Inserir Peão Mestre</title>
...
<body>
    <div class="container">
        <div class="fundo">
            <form action="recinserirpeaomestre.php" method="POST" id="forminserirpeaomestre" class="col s12">
                <p>Inserir Peão Mestre</p>
                <div class="input-field col s6">
                    <input placeholder="Digite o nome do peão mestre" id="nome" type="text" name="txtNome">
                </div>
                <div class="botoes">
